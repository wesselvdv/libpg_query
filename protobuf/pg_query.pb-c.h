...
typedef enum {
  PG_QUERY__NODE__SEALED_VALUE__NOT_SET = 0,
  PG_QUERY__NODE__SEALED_VALUE_ALIAS = 1,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_VAR = 2,
  PG_QUERY__NODE__SEALED_VALUE_TABLE_FUNC = 3,
  PG_QUERY__NODE__SEALED_VALUE_EXPR = 4,
  PG_QUERY__NODE__SEALED_VALUE_VAR = 5,
  PG_QUERY__NODE__SEALED_VALUE_PARAM = 6,
  PG_QUERY__NODE__SEALED_VALUE_AGGREF = 7,
  PG_QUERY__NODE__SEALED_VALUE_GROUPING_FUNC = 8,
  PG_QUERY__NODE__SEALED_VALUE_WINDOW_FUNC = 9,
  PG_QUERY__NODE__SEALED_VALUE_SUBSCRIPTING_REF = 10,
  PG_QUERY__NODE__SEALED_VALUE_FUNC_EXPR = 11,
  PG_QUERY__NODE__SEALED_VALUE_NAMED_ARG_EXPR = 12,
  PG_QUERY__NODE__SEALED_VALUE_OP_EXPR = 13,
  PG_QUERY__NODE__SEALED_VALUE_DISTINCT_EXPR = 14,
  PG_QUERY__NODE__SEALED_VALUE_NULL_IF_EXPR = 15,
  PG_QUERY__NODE__SEALED_VALUE_SCALAR_ARRAY_OP_EXPR = 16,
  PG_QUERY__NODE__SEALED_VALUE_BOOL_EXPR = 17,
  PG_QUERY__NODE__SEALED_VALUE_SUB_LINK = 18,
  PG_QUERY__NODE__SEALED_VALUE_SUB_PLAN = 19,
  PG_QUERY__NODE__SEALED_VALUE_ALTERNATIVE_SUB_PLAN = 20,
  PG_QUERY__NODE__SEALED_VALUE_FIELD_SELECT = 21,
  PG_QUERY__NODE__SEALED_VALUE_FIELD_STORE = 22,
  PG_QUERY__NODE__SEALED_VALUE_RELABEL_TYPE = 23,
  PG_QUERY__NODE__SEALED_VALUE_COERCE_VIA_IO = 24,
  PG_QUERY__NODE__SEALED_VALUE_ARRAY_COERCE_EXPR = 25,
  PG_QUERY__NODE__SEALED_VALUE_CONVERT_ROWTYPE_EXPR = 26,
  PG_QUERY__NODE__SEALED_VALUE_COLLATE_EXPR = 27,
  PG_QUERY__NODE__SEALED_VALUE_CASE_EXPR = 28,
  PG_QUERY__NODE__SEALED_VALUE_CASE_WHEN = 29,
  PG_QUERY__NODE__SEALED_VALUE_CASE_TEST_EXPR = 30,
  PG_QUERY__NODE__SEALED_VALUE_ARRAY_EXPR = 31,
  PG_QUERY__NODE__SEALED_VALUE_ROW_EXPR = 32,
  PG_QUERY__NODE__SEALED_VALUE_ROW_COMPARE_EXPR = 33,
  PG_QUERY__NODE__SEALED_VALUE_COALESCE_EXPR = 34,
  PG_QUERY__NODE__SEALED_VALUE_MIN_MAX_EXPR = 35,
  PG_QUERY__NODE__SEALED_VALUE_SQLVALUE_FUNCTION = 36,
  PG_QUERY__NODE__SEALED_VALUE_XML_EXPR = 37,
  PG_QUERY__NODE__SEALED_VALUE_NULL_TEST = 38,
  PG_QUERY__NODE__SEALED_VALUE_BOOLEAN_TEST = 39,
  PG_QUERY__NODE__SEALED_VALUE_COERCE_TO_DOMAIN = 40,
  PG_QUERY__NODE__SEALED_VALUE_COERCE_TO_DOMAIN_VALUE = 41,
  PG_QUERY__NODE__SEALED_VALUE_SET_TO_DEFAULT = 42,
  PG_QUERY__NODE__SEALED_VALUE_CURRENT_OF_EXPR = 43,
  PG_QUERY__NODE__SEALED_VALUE_NEXT_VALUE_EXPR = 44,
  PG_QUERY__NODE__SEALED_VALUE_INFERENCE_ELEM = 45,
  PG_QUERY__NODE__SEALED_VALUE_TARGET_ENTRY = 46,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TBL_REF = 47,
  PG_QUERY__NODE__SEALED_VALUE_JOIN_EXPR = 48,
  PG_QUERY__NODE__SEALED_VALUE_FROM_EXPR = 49,
  PG_QUERY__NODE__SEALED_VALUE_ON_CONFLICT_EXPR = 50,
  PG_QUERY__NODE__SEALED_VALUE_INTO_CLAUSE = 51,
  PG_QUERY__NODE__SEALED_VALUE_RAW_STMT = 52,
  PG_QUERY__NODE__SEALED_VALUE_QUERY = 53,
  PG_QUERY__NODE__SEALED_VALUE_INSERT_STMT = 54,
  PG_QUERY__NODE__SEALED_VALUE_DELETE_STMT = 55,
  PG_QUERY__NODE__SEALED_VALUE_UPDATE_STMT = 56,
  PG_QUERY__NODE__SEALED_VALUE_SELECT_STMT = 57,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TABLE_STMT = 58,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TABLE_CMD = 59,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_DOMAIN_STMT = 60,
  PG_QUERY__NODE__SEALED_VALUE_SET_OPERATION_STMT = 61,
  PG_QUERY__NODE__SEALED_VALUE_GRANT_STMT = 62,
  PG_QUERY__NODE__SEALED_VALUE_GRANT_ROLE_STMT = 63,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_DEFAULT_PRIVILEGES_STMT = 64,
  PG_QUERY__NODE__SEALED_VALUE_CLOSE_PORTAL_STMT = 65,
  PG_QUERY__NODE__SEALED_VALUE_CLUSTER_STMT = 66,
  PG_QUERY__NODE__SEALED_VALUE_COPY_STMT = 67,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_STMT = 68,
  PG_QUERY__NODE__SEALED_VALUE_DEFINE_STMT = 69,
  PG_QUERY__NODE__SEALED_VALUE_DROP_STMT = 70,
  PG_QUERY__NODE__SEALED_VALUE_TRUNCATE_STMT = 71,
  PG_QUERY__NODE__SEALED_VALUE_COMMENT_STMT = 72,
  PG_QUERY__NODE__SEALED_VALUE_FETCH_STMT = 73,
  PG_QUERY__NODE__SEALED_VALUE_INDEX_STMT = 74,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_FUNCTION_STMT = 75,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_FUNCTION_STMT = 76,
  PG_QUERY__NODE__SEALED_VALUE_DO_STMT = 77,
  PG_QUERY__NODE__SEALED_VALUE_RENAME_STMT = 78,
  PG_QUERY__NODE__SEALED_VALUE_RULE_STMT = 79,
  PG_QUERY__NODE__SEALED_VALUE_NOTIFY_STMT = 80,
  PG_QUERY__NODE__SEALED_VALUE_LISTEN_STMT = 81,
  PG_QUERY__NODE__SEALED_VALUE_UNLISTEN_STMT = 82,
  PG_QUERY__NODE__SEALED_VALUE_TRANSACTION_STMT = 83,
  PG_QUERY__NODE__SEALED_VALUE_VIEW_STMT = 84,
  PG_QUERY__NODE__SEALED_VALUE_LOAD_STMT = 85,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_DOMAIN_STMT = 86,
  PG_QUERY__NODE__SEALED_VALUE_CREATEDB_STMT = 87,
  PG_QUERY__NODE__SEALED_VALUE_DROPDB_STMT = 88,
  PG_QUERY__NODE__SEALED_VALUE_VACUUM_STMT = 89,
  PG_QUERY__NODE__SEALED_VALUE_EXPLAIN_STMT = 90,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_TABLE_AS_STMT = 91,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_SEQ_STMT = 92,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_SEQ_STMT = 93,
  PG_QUERY__NODE__SEALED_VALUE_VARIABLE_SET_STMT = 94,
  PG_QUERY__NODE__SEALED_VALUE_VARIABLE_SHOW_STMT = 95,
  PG_QUERY__NODE__SEALED_VALUE_DISCARD_STMT = 96,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_TRIG_STMT = 97,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_PLANG_STMT = 98,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_ROLE_STMT = 99,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_ROLE_STMT = 100,
  PG_QUERY__NODE__SEALED_VALUE_DROP_ROLE_STMT = 101,
  PG_QUERY__NODE__SEALED_VALUE_LOCK_STMT = 102,
  PG_QUERY__NODE__SEALED_VALUE_CONSTRAINTS_SET_STMT = 103,
  PG_QUERY__NODE__SEALED_VALUE_REINDEX_STMT = 104,
  PG_QUERY__NODE__SEALED_VALUE_CHECK_POINT_STMT = 105,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_SCHEMA_STMT = 106,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_DATABASE_STMT = 107,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_DATABASE_SET_STMT = 108,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_ROLE_SET_STMT = 109,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_CONVERSION_STMT = 110,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_CAST_STMT = 111,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_OP_CLASS_STMT = 112,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_OP_FAMILY_STMT = 113,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_OP_FAMILY_STMT = 114,
  PG_QUERY__NODE__SEALED_VALUE_PREPARE_STMT = 115,
  PG_QUERY__NODE__SEALED_VALUE_EXECUTE_STMT = 116,
  PG_QUERY__NODE__SEALED_VALUE_DEALLOCATE_STMT = 117,
  PG_QUERY__NODE__SEALED_VALUE_DECLARE_CURSOR_STMT = 118,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_TABLE_SPACE_STMT = 119,
  PG_QUERY__NODE__SEALED_VALUE_DROP_TABLE_SPACE_STMT = 120,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_OBJECT_DEPENDS_STMT = 121,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_OBJECT_SCHEMA_STMT = 122,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_OWNER_STMT = 123,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_OPERATOR_STMT = 124,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TYPE_STMT = 125,
  PG_QUERY__NODE__SEALED_VALUE_DROP_OWNED_STMT = 126,
  PG_QUERY__NODE__SEALED_VALUE_REASSIGN_OWNED_STMT = 127,
  PG_QUERY__NODE__SEALED_VALUE_COMPOSITE_TYPE_STMT = 128,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_ENUM_STMT = 129,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_RANGE_STMT = 130,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_ENUM_STMT = 131,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TSDICTIONARY_STMT = 132,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TSCONFIGURATION_STMT = 133,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_FDW_STMT = 134,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_FDW_STMT = 135,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_FOREIGN_SERVER_STMT = 136,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_FOREIGN_SERVER_STMT = 137,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_USER_MAPPING_STMT = 138,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_USER_MAPPING_STMT = 139,
  PG_QUERY__NODE__SEALED_VALUE_DROP_USER_MAPPING_STMT = 140,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TABLE_SPACE_OPTIONS_STMT = 141,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_TABLE_MOVE_ALL_STMT = 142,
  PG_QUERY__NODE__SEALED_VALUE_SEC_LABEL_STMT = 143,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_FOREIGN_TABLE_STMT = 144,
  PG_QUERY__NODE__SEALED_VALUE_IMPORT_FOREIGN_SCHEMA_STMT = 145,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_EXTENSION_STMT = 146,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_EXTENSION_STMT = 147,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_EXTENSION_CONTENTS_STMT = 148,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_EVENT_TRIG_STMT = 149,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_EVENT_TRIG_STMT = 150,
  PG_QUERY__NODE__SEALED_VALUE_REFRESH_MAT_VIEW_STMT = 151,
  PG_QUERY__NODE__SEALED_VALUE_REPLICA_IDENTITY_STMT = 152,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_SYSTEM_STMT = 153,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_POLICY_STMT = 154,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_POLICY_STMT = 155,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_TRANSFORM_STMT = 156,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_AM_STMT = 157,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_PUBLICATION_STMT = 158,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_PUBLICATION_STMT = 159,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_SUBSCRIPTION_STMT = 160,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_SUBSCRIPTION_STMT = 161,
  PG_QUERY__NODE__SEALED_VALUE_DROP_SUBSCRIPTION_STMT = 162,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_STATS_STMT = 163,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_COLLATION_STMT = 164,
  PG_QUERY__NODE__SEALED_VALUE_CALL_STMT = 165,
  PG_QUERY__NODE__SEALED_VALUE_ALTER_STATS_STMT = 166,
  PG_QUERY__NODE__SEALED_VALUE_A_EXPR = 167,
  PG_QUERY__NODE__SEALED_VALUE_COLUMN_REF = 168,
  PG_QUERY__NODE__SEALED_VALUE_PARAM_REF = 169,
  PG_QUERY__NODE__SEALED_VALUE_A_CONST = 170,
  PG_QUERY__NODE__SEALED_VALUE_FUNC_CALL = 171,
  PG_QUERY__NODE__SEALED_VALUE_A_STAR = 172,
  PG_QUERY__NODE__SEALED_VALUE_A_INDICES = 173,
  PG_QUERY__NODE__SEALED_VALUE_A_INDIRECTION = 174,
  PG_QUERY__NODE__SEALED_VALUE_A_ARRAY_EXPR = 175,
  PG_QUERY__NODE__SEALED_VALUE_RES_TARGET = 176,
  PG_QUERY__NODE__SEALED_VALUE_MULTI_ASSIGN_REF = 177,
  PG_QUERY__NODE__SEALED_VALUE_TYPE_CAST = 178,
  PG_QUERY__NODE__SEALED_VALUE_COLLATE_CLAUSE = 179,
  PG_QUERY__NODE__SEALED_VALUE_SORT_BY = 180,
  PG_QUERY__NODE__SEALED_VALUE_WINDOW_DEF = 181,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_SUBSELECT = 182,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_FUNCTION = 183,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TABLE_SAMPLE = 184,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TABLE_FUNC = 185,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TABLE_FUNC_COL = 186,
  PG_QUERY__NODE__SEALED_VALUE_TYPE_NAME = 187,
  PG_QUERY__NODE__SEALED_VALUE_COLUMN_DEF = 188,
  PG_QUERY__NODE__SEALED_VALUE_INDEX_ELEM = 189,
  PG_QUERY__NODE__SEALED_VALUE_CONSTRAINT = 190,
  PG_QUERY__NODE__SEALED_VALUE_DEF_ELEM = 191,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TBL_ENTRY = 192,
  PG_QUERY__NODE__SEALED_VALUE_RANGE_TBL_FUNCTION = 193,
  PG_QUERY__NODE__SEALED_VALUE_TABLE_SAMPLE_CLAUSE = 194,
  PG_QUERY__NODE__SEALED_VALUE_WITH_CHECK_OPTION = 195,
  PG_QUERY__NODE__SEALED_VALUE_SORT_GROUP_CLAUSE = 196,
  PG_QUERY__NODE__SEALED_VALUE_GROUPING_SET = 197,
  PG_QUERY__NODE__SEALED_VALUE_WINDOW_CLAUSE = 198,
  PG_QUERY__NODE__SEALED_VALUE_OBJECT_WITH_ARGS = 199,
  PG_QUERY__NODE__SEALED_VALUE_ACCESS_PRIV = 200,
  PG_QUERY__NODE__SEALED_VALUE_CREATE_OP_CLASS_ITEM = 201,
  PG_QUERY__NODE__SEALED_VALUE_TABLE_LIKE_CLAUSE = 202,
  PG_QUERY__NODE__SEALED_VALUE_FUNCTION_PARAMETER = 203,
  PG_QUERY__NODE__SEALED_VALUE_LOCKING_CLAUSE = 204,
  PG_QUERY__NODE__SEALED_VALUE_ROW_MARK_CLAUSE = 205,
  PG_QUERY__NODE__SEALED_VALUE_XML_SERIALIZE = 206,
  PG_QUERY__NODE__SEALED_VALUE_WITH_CLAUSE = 207,
  PG_QUERY__NODE__SEALED_VALUE_INFER_CLAUSE = 208,
  PG_QUERY__NODE__SEALED_VALUE_ON_CONFLICT_CLAUSE = 209,
  PG_QUERY__NODE__SEALED_VALUE_COMMON_TABLE_EXPR = 210,
  PG_QUERY__NODE__SEALED_VALUE_ROLE_SPEC = 211,
  PG_QUERY__NODE__SEALED_VALUE_TRIGGER_TRANSITION = 212,
  PG_QUERY__NODE__SEALED_VALUE_PARTITION_ELEM = 213,
  PG_QUERY__NODE__SEALED_VALUE_PARTITION_SPEC = 214,
  PG_QUERY__NODE__SEALED_VALUE_PARTITION_BOUND_SPEC = 215,
  PG_QUERY__NODE__SEALED_VALUE_PARTITION_RANGE_DATUM = 216,
  PG_QUERY__NODE__SEALED_VALUE_PARTITION_CMD = 217,
  PG_QUERY__NODE__SEALED_VALUE_VACUUM_RELATION = 218,
  PG_QUERY__NODE__SEALED_VALUE_INLINE_CODE_BLOCK = 219,
  PG_QUERY__NODE__SEALED_VALUE_CALL_CONTEXT = 220,
  PG_QUERY__NODE__SEALED_VALUE_INTEGER = 221,
  PG_QUERY__NODE__SEALED_VALUE_FLOAT = 222,
  PG_QUERY__NODE__SEALED_VALUE_STRING = 223,
  PG_QUERY__NODE__SEALED_VALUE_BIT_STRING = 224,
  PG_QUERY__NODE__SEALED_VALUE_NULL = 225,
  PG_QUERY__NODE__SEALED_VALUE_LIST = 226,
  PG_QUERY__NODE__SEALED_VALUE_INT_LIST = 227,
  PG_QUERY__NODE__SEALED_VALUE_OID_LIST = 228
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PG_QUERY__NODE__SEALED_VALUE__CASE)
} PgQuery__Node__SealedValueCase;

struct  PgQuery__Node
{
  ProtobufCMessage base;
  PgQuery__Node__SealedValueCase sealed_value_case;
  union {
